...
/trade/:username          → Trade.jsx (public)
```
...
- The old Supabase `card_hashes` table was dropped by `supabase/migrations/20260703000000_drop_card_hashes.sql`; the static hash pack is now the sole hash store.
