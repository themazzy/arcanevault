...
const cases = [
  ...
  // ── Finisher (mass pump + trample, extra combat, team double strike) ──────
  ['Overrun (pump-then-trample overrun spell)',
    'Creatures you control get +3/+3 and gain trample until end of turn.',
    'Sorcery', 'Finisher'],
  ['Craterhoof Behemoth (trample-then-pump, +X/+X)',
    ...
    'Creature — Beast', 'Finisher'],
  ['Overwhelming Stampede (leading "Until end of turn" clause)',
    'Until end of turn, creatures you control gain trample and get +X/+X, where X is the greatest power among creatures you control.',
    'Sorcery', 'Finisher'],
  ['End-Raze Forerunners (+2/+2 past the static-anthem lookahead → Finisher)',
    'Vigilance, trample, haste\nWhen this creature enters, other creatures you control get +2/+2 and gain vigilance and trample until end of turn.',
    'Creature — Boar', 'Finisher'],
  ['Aggravated Assault (extra combat phase)',
  ...
  ['Scourge of the Throne (extra combat wins over its Dethrone +1/+1 counter)',
    ...
    'Creature — Dragon', 'Finisher'],
  ['Berserkers\' Onslaught (team double strike)',
    'Attacking creatures you control have double strike.',
    'Enchantment', 'Finisher'],
  ['Balmor (repeatable "whenever" trample pump stays Anthem, not Finisher)',
  ...
  ['Traumatize (half-library mill → Finisher, the mill wincon)',
    'Target player mills half their library, rounded down.',
    'Sorcery', 'Finisher'],
  ['Maddening Cacophony (each-opponent mill → Finisher)',
    'Kicker {3}{U}\nEach opponent mills eight cards. If this spell was kicked, instead each opponent mills half their library, rounded up.',
    'Sorcery', 'Finisher'],
  ['Fleet Swallower (creature that mills half a library → Finisher)',
    'Whenever this creature attacks, target player mills half their library, rounded up.',
    'Creature — Fish', 'Finisher'],
  ['Stitcher\'s Supplier (self-mill for graveyard fuel stays Mill)',
    'When this creature enters and when it dies, mill three cards.',
    'Creature — Zombie', 'Mill'],
  ['Blaze (X damage to any target → Finisher)',
    'Blaze deals X damage to any target.',
    'Sorcery', 'Finisher'],
  ['Fireball (X damage divided among targets → Finisher)',
    'This spell costs {1} more to cast for each target beyond the first.\nFireball deals X damage divided evenly, rounded down, among any number of targets.',
    'Sorcery', 'Finisher'],
  ['Comet Storm (X damage to each of them → Finisher)',
    ...
    'Instant', 'Finisher'],
  ['Crackle with Power (five times X damage → Finisher)',
    'Crackle with Power deals five times X damage to each of up to X targets.',
    'Sorcery', 'Finisher'],
  ['Bonfire of the Damned (X damage to target player + board → Finisher)',
    ...
    'Sorcery', 'Finisher'],
  ['Lightning Bolt (fixed damage stays Removal, not Finisher)',
    'Lightning Bolt deals 3 damage to any target.',
    'Instant', 'Removal'],
  ['Soul\'s Fire (fight-style "damage equal to its power" stays Removal)',
  ...
  ['High Tide ("adds an additional {U}" — modern reprint wording)',
    'Until end of turn, whenever a player taps an Island for mana, that player adds an additional {U}.',
    'Instant', 'Ramp'],
  ['Time Stretch ("Target player takes two extra turns" — modern reprint)',
    'Target player takes two extra turns after this one.',
    'Sorcery', 'Extra Turns'],
  ['Time Warp ("Take an extra turn" — original imperative wording)',
    'Take an extra turn after this one.',
    'Sorcery', 'Extra Turns'],
  ...
  ['Chaos Warp (shuffle target permanent into library)',
    ...
    'Instant', 'Removal'],
  // Comet Storm / Fireball moved to the Finisher section (scalable X-damage is
  // a win condition, not spot removal) — see cases above.
  ...
  ['City on Fire (MOM — "triple that damage" → Doublers)',
    ...
    'Enchantment', 'Doublers'],
  ['City on Fire (legacy: "double that damage" → Doublers)',
