...
const CHANGELOG = [
  ...
  },
  {
    ...
    updates: [
      ...
      '📊 Deck win/loss stats — results are saved per deck after each game and shown in the player config',
      '👤 Preferred nickname in Settings — auto-fills as your name when creating any game lobby',
      '🃏 Local lobby deck selection only shown for the host (Player 1)',
      '🐛 Bug report & feature request button in the app menu',
      '🎨 OLED black mode fully fixed — all surfaces go pitch black, dot-grid removed',
    ],
  },
  {
    version: 'WIP',
